...
module.exports = function(Translate, app, auth, database) {
    ...
    app.get('/translate/example/anyone', function(req, res, next) {
        res.send('Anyone can access this');
    });

    app.get('/translate/example/auth', auth.requiresLogin, function(req, res, next) {
        res.send('Only authenticated users can access this');
    });

    app.get('/translate/example/admin', auth.requiresAdmin, function(req, res, next) {
        res.send('Only users with Admin role can access this');
    });

    app.get('/translate/example/render', function(req, res, next) {
