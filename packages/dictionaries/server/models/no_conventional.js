...
NoConventionalSchema.pre('validate', function (next) {
...
//**************** Eliminar los campos de Proyecto (P) y Conferencia (C) en caso de no exitir *****************/
    ...
    if (this.v5) {
        if (this.v5 !== 'NC') {//Si no es una Conferencia o Evento (C)
        ...
        if (this.v5 !== 'NP') { //Si no es un Proyecto (P)
            delete this._doc.v58;
            delete this._doc.v59;
            delete this._doc.v60;
        }
        if (this.v5 !== 'NC' && this.v5 !== 'NP') { //Si no es ni Conferencia ni Proyecto
...
NoConventionalSchema.path('v4').validate(function (value) {
    return value.length ? true : false;
}, 'The field "v4" is obligatory');

NoConventionalSchema.path('v12').validate(function (value) {
    if ((this.v5 === 'N' || this.v5 === 'NC' || this.v5 === 'NP') && (this.v6 === 'am')) {
        if (!value.length) {
            return false;
        }
    }
...
NoConventionalSchema.path('v14').validate(function (value) { //1
...
NoConventionalSchema.path('v14').validate(function (value) { //2
...
NoConventionalSchema.path('v18').validate(function (value) {
    return value.length ? true : false;
}, 'The field "v18" is obligatory');

NoConventionalSchema.path('v40').validate(function (value) {
    return value.length ? true : false;
}, 'The field "v40" is obligatory');

NoConventionalSchema.path('v53').validate(function (value) {
    if (this.v5 === 'NC') {//Si es una Conferencia o Evento (C)
        if (!value.length) {
            return false;
        }
    }
...
NoConventionalSchema.path('v54').validate(function (value) {
    if (this.v5 === 'NC') {//Si es una Conferencia o Evento (C)
        if (!value) {
            return false;
        }
...
NoConventionalSchema.path('v55').validate(function (value) {
    if (this.v54) {
...
NoConventionalSchema.path('v56').validate(function (value) {
    if (this.v5 === 'NC') {//Si es una Conferencia o Evento (C)
        if (!value) {
            return false;
        }
...
NoConventionalSchema.path('v62').validate(function (value) {
    return value.length ? true : false;
}, 'The field "v62" is obligatory');

NoConventionalSchema.path('v65').validate(function (value) {
...
NoConventionalSchema.path('v83').validate(function (value) {
    var cant = 0;
    for (var i = 0; i < value.length; i++) {
...
NoConventionalSchema.path('v87').validate(function (value) {
    return value.length ? true : false;
}, 'The field "v87" is obligatory');

NoConventionalSchema.path('v92').validate(function (value) {
    return value.length ? true : false;
 ...
 **********************************************************************************/
/*
 NoConventionalSchema.post('validate', function (next) {
...
NoConventionalSchema.pre('save', function (next) {
...
mongoose.model('NoConventional', NoConventionalSchema);
